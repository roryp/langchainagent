...
public class PromptEngineeringDemo {
     ...
     */
    private static void demonstrateZeroShot(ChatLanguageModel model) {
        System.out.println("\n" + "=".repeat(60));
     ...
     */
    private static void demonstrateFewShot(ChatLanguageModel model) {
        System.out.println("\n" + "=".repeat(60));
     ...
     */
    private static void demonstrateChainOfThought(ChatLanguageModel model) {
        System.out.println("\n" + "=".repeat(60));
     ...
     */
    private static void demonstrateRoleBased(ChatLanguageModel model) {
        System.out.println("\n" + "=".repeat(60));
